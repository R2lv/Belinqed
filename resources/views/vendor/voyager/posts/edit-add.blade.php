                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Title En" value="{{ $dataTypeContent->title_en ?? '' }}">
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="title_ka" placeholder="Title KA" value="{{ $dataTypeContent->title_ka ?? '' }}">
                                </div>
                            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            @php
                                ...
                                $row = $dataTypeRows->where('field', 'body_en')->first();
                            @endphp

                            <div class="row">
                                <div class="col-md-12">

                                    <h3 class="panel-title">Content En</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @php
                                        $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                        $row = $dataTypeRows->where('field', 'body_ka')->first();
                                    @endphp

                                    <h3 class="panel-title">Content Ka</h3>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea class="form-control" placeholder="Excerpt En" name="excerpt">{{ $dataTypeContent->excerpt_en ?? '' }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea class="form-control" placeholder="Excerpt Ka" name="excerpt">{{ $dataTypeContent->excerpt_ka ?? '' }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id', 'featured', 'image', 'meta_description', 'meta_keywords', 'seo_title', 'title_en', 'title_ka', 'body_en' ,'body_ka','excerpt_ka'];
                            @endphp
